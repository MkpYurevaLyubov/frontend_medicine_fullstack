...
const FormAuthorization: React.FC = () => {
  ...
  const onClickBtn = () => {
    axios
      .post('http://localhost:8000/api/authUser', user)
      .then((res) => {
      ...
      .catch((err) => {
        ...
        setUser({ login: '', password: '', password2: '' });
        setDisabledBtn(true);
        setSnackOpen({
          isOpen: true,
  ...
  return (
    <div className="mainAuth">
      ...
      <div className="authBtn">
        <Buttons text="Войти" onClick={onClickBtn} disabled={disabledBtn} />
      </div>
